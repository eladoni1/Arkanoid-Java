...
public class Paddle implements Sprite, Collidable {
    ...
    public Paddle(KeyboardSensor keyboard, int recWidth, int recHeight, int winWidth, int winHeight, int borderLeft, int borderRight, Color color) {
        // Default - half the screen.
        recWidth = recWidth > (0.5 * winWidth) ?  (int) (0.5 * winWidth) : recWidth;
        recHeight = recHeight > (0.5 * winHeight) ?  (int) (0.5 * winHeight) : recHeight;
    ...
    public Paddle(KeyboardSensor keyboard, int recWidth, int recHeight, int winWidth, int winHeight, int borderLeft, int borderRight, int movement, Color color) {
        // Default - half the screen.
        recWidth = recWidth > (0.5 * winWidth) ?  (int) (0.5 * winWidth) : recWidth;
        recHeight = recHeight > (0.5 * winHeight) ?  (int) (0.5 * winHeight) : recHeight;
